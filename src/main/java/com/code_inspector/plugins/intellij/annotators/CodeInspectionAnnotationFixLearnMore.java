...
import static com.code_inspector.plugins.intellij.ui.UIConstants.ANNOTATION_FIX_URL_LEARN_MORE;
 ...
 */
public class CodeInspectionAnnotationFixLearnMore implements IntentionAction {

    private final String url;

    public static final Logger LOGGER = Logger.getInstance(LOGGER_NAME);

    public CodeInspectionAnnotationFixLearnMore(String _url) {
        this.url = _url;
    }
