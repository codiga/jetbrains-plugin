...
public class UIConstants {
    ...
    public final static String SETTINGS_LABEL_CONFIGURE_PROJECT = "Configure Project on Codiga";
    ...
    public final static String ANNOTATION_FIX_OPEN_BROWSER = "See this violation on Codiga";
