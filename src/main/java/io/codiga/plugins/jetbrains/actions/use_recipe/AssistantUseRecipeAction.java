...
public class AssistantUseRecipeAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent event) {
        ...
        popup.setAdText("Enter terms to search recipes");
        popup.setSearchInAnyPlace(true);
        popup.setShowListForEmptyPattern(true);

        final DefaultActionGroup group = new DefaultActionGroup();
        final ActionToolbar actionToolbar = ActionManager.getInstance().createActionToolbar("Codiga", group, true);
...
//            actionToolbar.updateActionsImmediately();
        ...
        /**
         * TODO: figure out why it's always NON_MODAL
         *
         */
        ...
        popup.getTextField().addPropertyChangeListener(new PropertyChangeListener() {
            @Override
     ...
     * @param event
     */
    public void actionPerformedOld(@NotNull AnActionEvent event) {
        // reset results
        jLabelResults.setText(ENTER_SEARCH_TERM_TEXT);
        currentRecipes = null;
        currentRecipeIndex = 0;
