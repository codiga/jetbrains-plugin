...
public class ProjectSettingsComponent {
    ...
    public ProjectSettingsComponent() {
         ...
         * from the API.
         */
        messageBusConnection.subscribe(CODIGA_API_KEY_CHANGE_TOPIC, new ApiKeyChangeNotifier() {
            @Override
    ...
    private void buildInterface() {
        ...
        if (codigaApi.isWorking()) {
            projectList = codigaApi.getProjects();
     ...
     * @param projectIdentifier the identifier of the project on Codiga
     */
